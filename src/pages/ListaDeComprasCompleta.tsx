  ...
  const [categories, setCategories] = useState<Category[]>([
    {
      ...
      items: [
        { id: "v1", name: "Alface", checked: false },
        { id: "v2", name: "Tomate", checked: false },
        { id: "v3", name: "Cebola", checked: false },
        { id: "v4", name: "Alho", checked: false },
        { id: "v5", name: "Batata", checked: false },
        { id: "v6", name: "Cenoura", checked: false },
        { id: "v7", name: "Pepino", checked: false },
        { id: "v8", name: "Abobrinha", checked: false },
        { id: "v9", name: "Beterraba", checked: false },
        { id: "v10", name: "Xuxu", checked: false },
        { id: "v11", name: "Batata Doce", checked: false },
        { id: "v12", name: "Pimentão", checked: false },
        { id: "v13", name: "Mandioca", checked: false },
      ],
    },
    {
      name: "Frutas",
      items: [
        ...
        { id: "f2", name: "Maçã", checked: false },
        { id: "f3", name: "Laranja", checked: false },
        { id: "f4", name: "Limão", checked: false },
        { id: "f5", name: "Mamão", checked: false },
        { id: "f6", name: "Melancia", checked: false },
        { id: "f7", name: "Goiaba", checked: false },
        { id: "f8", name: "Pêra", checked: false },
        { id: "f9", name: "Ameixa", checked: false },
        { id: "f10", name: "Abacate", checked: false },
        { id: "f11", name: "Mexerica", checked: false },
      ],
    },
    {
      name: "Padaria",
