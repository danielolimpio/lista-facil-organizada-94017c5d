...
const MaterialEscolar3Ano = () => {
  const [categories, setCategories] = useState<Category[]>([
    {
      name: "Cadernos",
      icon: <BookOpen className="w-5 h-5" />,
      items: [
        { id: "c1", name: "Caderno universitário 1 matéria (96 folhas)", checked: false, quantity: "6 unidades" },
        { id: "c2", name: "Caderno de desenho grande", checked: false, quantity: "1 unidade" },
        { id: "c3", name: "Caderno quadriculado 0,5cm x 0,5cm", checked: false, quantity: "1 unidade" },
        { id: "c4", name: "Caderno pequeno para recados", checked: false, quantity: "1 unidade" },
        { id: "c5", name: "Bloco de folhas A4 pautadas", checked: false, quantity: "1 unidade" },
      ],
    },
    {
      ...
      items: [
        ...
        { id: "e2", name: "Caneta esferográfica azul", checked: false, quantity: "4 unidades" },
        { id: "e3", name: "Caneta esferográfica preta", checked: false, quantity: "2 unidades" },
        { id: "e4", name: "Caneta esferográfica vermelha", checked: false, quantity: "2 unidades" },
        { id: "e5", name: "Borracha branca macia", checked: false, quantity: "3 unidades" },
        { id: "e6", name: "Apontador com depósito", checked: false, quantity: "2 unidades" },
        { id: "e7", name: "Corretivo líquido", checked: false, quantity: "1 unidade" },
        { id: "e8", name: "Marca texto (4 cores)", checked: false, quantity: "1 kit" },
      ],
    },
    {
      ...
      items: [
        ...
        { id: "a6", name: "Pote para água", checked: false, quantity: "1 unidade" },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { id: "m1", name: "Régua 15cm", checked: false, quantity: "1 unidade" },
        { id: "m2", name: "Caderno quadriculado", checked: false, quantity: "1 unidade" },
        { id: "m3", name: "Material dourado (se solicitado)", checked: false, quantity: "1 kit" },
      ],
    },
  ]);
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="text-center mb-8 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Material Escolar 3° Ano
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-6">
              Lista completa para o terceiro ano — aprofundando conhecimentos e desenvolvendo autonomia
            </p>

            <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 text-purple-700 rounded-full font-semibold mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6">
              <Button onClick={handlePrint} className="bg-purple-600 hover:bg-purple-700" size="lg">
          ...
          {/* Dica */}
          <Card className="p-6 mb-8 border-purple-200 bg-gradient-to-r from-purple-50 to-purple-100/50">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  No terceiro ano, os alunos começam a ter mais autonomia. Invista em <strong>marca-textos</strong> 
                  para destacar informações importantes e uma <strong>agenda</strong> para anotar tarefas. 
                  Materiais de matemática como régua e caderno quadriculado são essenciais.
                </p>
              </div>
            </div>
          </Card>
          ...
          <div className="space-y-6 print:space-y-4">
            {filteredCategories.map((category, categoryIndex) => {
              ...
              return (
                <Card key={category.name} className="p-6 print:break-inside-avoid border-l-4 border-l-purple-500">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <Checkbox
                            ...
                            className="print:hidden data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                          />
                          <label
                            htmlFor={item.id}
          ...
          <div className="mt-12 print:hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {onlineStores.map((store) => (
                <a
                  ...
                  className="group"
                >
                  <Card className="p-6 h-full border-2 border-transparent hover:border-purple-300 hover:shadow-lg transition-all duration-300">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-purple-100 flex items-center justify-center text-purple-600 group-hover:bg-purple-600 group-hover:text-white transition-colors">
                        {store.icon}
                      </div>
                      <div className="flex-1">
                        ...
                        <span className="inline-block px-2 py-0.5 text-xs font-semibold text-purple-600 bg-purple-100 rounded-full mb-2">
                          {store.highlight}
                        </span>
            ...
            <Card className="mt-6 p-6 bg-gradient-to-r from-purple-500 to-purple-600 text-white border-0">
              <div className="flex flex-col md:flex-row items-center gap-4">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-xl font-bold mb-2">
                    Dica de Economia para o 3° Ano
                  </h3>
                  <p className="text-white/90 text-sm">
                    Monte um kit de reposição com lápis, borracha e cola para o meio do ano. Comprando 
                    em quantidade no início, você economiza e evita gastos extras durante o ano letivo.
                  </p>
                </div>
              </div>
            </Card>
          ...
          <Card className="p-6 mt-8 bg-muted/30">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              <Link to="/lista-de-material-escolar-2026" className="text-sm text-purple-600 hover:underline">
                → Lista Geral 2026
              </Link>
              <Link to="/lista-de-material-escolar-1-ano" className="text-sm text-purple-600 hover:underline">
                → 1° Ano
              </Link>
              <Link to="/lista-de-material-escolar-2-ano" className="text-sm text-purple-600 hover:underline">
                → 2° Ano
              </Link>
              <Link to="/lista-de-material-escolar-4-ano" className="text-sm text-purple-600 hover:underline">
                → 4° Ano
              </Link>
              <Link to="/lista-de-material-escolar-educacao-infantil" className="text-sm text-purple-600 hover:underline">
                → Educação Infantil
              </Link>
            </div>
          </Card>
...
export default MaterialEscolar3Ano;
