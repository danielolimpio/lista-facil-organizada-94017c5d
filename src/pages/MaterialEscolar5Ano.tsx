  ...
  const [categories, setCategories] = useState<Category[]>([
    {
      ...
      items: [
        ...
        { id: "c2", name: "Caderno universitário 1 matéria (96 folhas)", checked: false, quantity: "6 unidades" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "e2", name: "Lapiseira 0.7mm", checked: false, quantity: "2 unidades" },
        { id: "e3", name: "Grafite 0.7mm", checked: false, quantity: "3 tubos" },
        { id: "e4", name: "Caneta esferográfica azul", checked: false, quantity: "6 unidades" },
        { id: "e5", name: "Caneta esferográfica preta", checked: false, quantity: "4 unidades" },
        { id: "e6", name: "Caneta esferográfica vermelha", checked: false, quantity: "2 unidades" },
        { id: "e7", name: "Caneta esferográfica verde", checked: false, quantity: "2 unidades" },
        { id: "e8", name: "Borracha branca macia", checked: false, quantity: "3 unidades" },
        { id: "e9", name: "Apontador com depósito", checked: false, quantity: "2 unidades" },
        { id: "e10", name: "Corretivo líquido", checked: false, quantity: "2 unidades" },
        { id: "e11", name: "Fita corretiva", checked: false, quantity: "2 unidades" },
        { id: "e12", name: "Marca texto (6 cores)", checked: false, quantity: "1 kit" },
      ],
    },
    {
      name: "Artes",
      ...
      items: [
        ...
        { id: "a5", name: "Paleta para tinta", checked: false, quantity: "1 unidade" },
      ],
    },
    {
      ...
      items: [
        ...
        { id: "r8", name: "EVA sortido", checked: false, quantity: "10 folhas" },
      ],
    },
    {
      ...
      items: [
        ...
        { id: "g6", name: "Compasso escolar de qualidade", checked: false, quantity: "1 unidade" },
        { id: "g7", name: "Calculadora científica simples", checked: false, quantity: "1 unidade" },
      ],
    },
    {
      name: "Organização",
      ...
      items: [
        ...
        { id: "o3", name: "Pasta com elástico", checked: false, quantity: "3 unidades" },
        { id: "o4", name: "Pasta catálogo com plásticos", checked: false, quantity: "1 unidade" },
        { id: "o5", name: "Fichário universitário", checked: false, quantity: "1 unidade" },
        { id: "o6", name: "Agenda escolar", checked: false, quantity: "1 unidade" },
        { id: "o7", name: "Post-it colorido", checked: false, quantity: "2 blocos" },
        { id: "o8", name: "Separadores de matérias", checked: false, quantity: "1 kit" },
      ],
    },
    {
      ...
      items: [
        { id: "s1", name: "Dicionário de Português", checked: false, quantity: "1 unidade" },
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="text-center mb-8 animate-fade-in">
            <div className="inline-flex p-4 bg-amber-100 rounded-2xl mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6">
              <Button onClick={handlePrint} className="bg-amber-600 hover:bg-amber-700" size="lg">
                <Printer className="w-4 h-4 mr-2" />
                Imprimir Lista
              </Button>
              <Button variant="outline" size="lg" className="border-amber-300 hover:bg-amber-50">
          ...
          {/* Dica */}
          <Card className="p-6 mb-8 border-amber-200 bg-gradient-to-r from-amber-50 to-amber-100/50">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  O quinto ano marca a <strong>transição para o Fundamental II</strong>. Introduza a <strong>calculadora científica</strong> se permitido pela escola, 
                  e invista em um <strong>fichário</strong> para organizar provas e trabalhos. A <strong>autonomia</strong> começa aqui!
                </p>
              </div>
            </div>
          </Card>
          ...
          <div className="space-y-6 print:space-y-4">
            {filteredCategories.map((category, categoryIndex) => {
              ...
              return (
                <Card key={category.name} className="p-6 print:break-inside-avoid border-l-4 border-l-amber-500">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {category.items.map((item) => (
                      <div
                        key={item.id}
                        className="flex items-center justify-between p-3 rounded-lg hover:bg-amber-50 transition-colors border border-transparent hover:border-amber-200"
                      >
                        <div className="flex items-center gap-3">
                          <Checkbox
                            ...
                            className="print:hidden data-[state=checked]:bg-amber-600 data-[state=checked]:border-amber-600"
                          />
                          <label
                            htmlFor={item.id}
          ...
          <div className="mt-12 print:hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {onlineStores.map((store) => (
                <a
                  ...
                  className="group"
                >
                  <Card className="p-6 h-full border-2 border-transparent hover:border-amber-300 hover:shadow-lg transition-all duration-300">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-amber-100 flex items-center justify-center text-amber-600 group-hover:bg-amber-600 group-hover:text-white transition-colors">
                        {store.icon}
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <ExternalLink className="w-4 h-4 text-muted-foreground group-hover:text-amber-600" />
                        </div>
                        <span className="inline-block px-2 py-0.5 text-xs font-semibold text-amber-600 bg-amber-100 rounded-full mb-2">
                          {store.highlight}
                        </span>
            ...
            <Card className="mt-6 p-6 bg-gradient-to-r from-amber-500 to-amber-600 text-white border-0">
              <div className="flex flex-col md:flex-row items-center gap-4">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-xl font-bold mb-2">
                    Dica de Economia para o 5° Ano
                  </h3>
                  <p className="text-white/90 text-sm">
                    Aproveite para comprar materiais que serão usados no Fundamental II. 
                    O kit de geometria, fichário e calculadora científica básica servem por vários anos. 
                    Invista em qualidade agora e economize no futuro!
                  </p>
                </div>
              </div>
            </Card>
          ...
          <Card className="p-6 mt-8 bg-muted/30">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              <Link to="/lista-de-material-escolar-4-ano" className="text-amber-600 hover:underline text-sm">
                → 4° Ano
              </Link>
              <Link to="/lista-de-material-escolar-6-ano" className="text-amber-600 hover:underline text-sm">
                → 6° Ano
              </Link>
              <Link to="/lista-de-material-escolar-7-ano" className="text-amber-600 hover:underline text-sm">
                → 7° Ano
              </Link>
              <Link to="/lista-de-material-escolar-8-ano" className="text-amber-600 hover:underline text-sm">
                → 8° Ano
              </Link>
              <Link to="/lista-de-material-escolar-9-ano" className="text-amber-600 hover:underline text-sm">
                → 9° Ano
              </Link>
              <Link to="/lista-de-material-escolar-ensino-medio" className="text-amber-600 hover:underline text-sm">
                → Ensino Médio
              </Link>
              <Link to="/lista-de-material-escolar-2026" className="text-amber-600 hover:underline text-sm font-semibold">
                → Lista Geral 2026
              </Link>
            </div>
          </Card>
...
export default MaterialEscolar5Ano;
